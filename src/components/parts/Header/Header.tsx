...
function Header() {
  return (
    ...
    <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-7xl  min-h-20">
            <a href="https://flowbite.com" className="flex items-center">
                <img src={logo} className="mr-3 h-8 sm:h-12" alt="Dev Labs Logo" />
                <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Dev Labs Events</span>
            </a>
      ...
      <Link to="/about" className="[&.active]:font-bold">
        About
                                        ...
                                        <li>
                <Link to="/events/labor" className="[&.active]:font-bold">
        Labor
      </Link>
                    </li>
                                        <li>
